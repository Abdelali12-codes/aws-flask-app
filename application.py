...
class EmployeeForm(FlaskForm):
    ...
    full_name = TextField(u'Full Name', [validators.InputRequired()])
    location = TextField(u'Location', [validators.InputRequired()])
    job_title = TextField(u'Job Title', [validators.InputRequired()])
